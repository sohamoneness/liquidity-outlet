...
@Component({
  selector: 'app-category-wise-compare',
  templateUrl: './category-wise-compare.page.html',
  styleUrls: ['./category-wise-compare.page.scss'],
})
export class CategoryWiseComparePage implements OnInit {
  userDetails: any;
  startDate: any = '';
  endDate: any = '';
  today: any = '';
  ...
  getReport() {
    if (this.endDate && !this.startDate) {
      ...
      this._api.reportCategoryWiseCompare(report).subscribe((res: any) => {
